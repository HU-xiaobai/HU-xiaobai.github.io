...
* **Agent Memory, Retrieval, and Evaluation for Long-Horizon LLM Agents**. My main research investigates how LLM agents select, organise, retrieve, and maintain past experience for reliable generation and decision-making. In early work, I studied retrieval augmented generation and reader aligned retrieval, including efficient question–answer representations [EEE-QA, COLING 2024](https://aclanthology.org/2024.lrec-main.490/), embedding-level retrieval control for open-domain QA [EmbQA, ACL 2025 Main](https://arxiv.org/abs/2503.01606) and reader-aware retrieval summarisation
[Spectrum Projection Score (SPS), AAAI 2026 Oral](https://arxiv.org/abs/2508.05909). More recently, I have extended this research line to agent memory, formalising it as a structured retrieval and organisation problem beyond standard RAG [xMemory, Arxiv 2026.02](https://arxiv.org/abs/2602.02007). My current work further explores **group-conversation and group-memory evaluation**, as well as **utility-driven adaptive memory architectures**, where memory granularity, hierarchy, and inter-memory relations can continually adapt as agents accumulate experience. Across these settings, I study how past experience can be evaluated, structured, and retrieved to support reliable reasoning and decision-making in long-horizon agentic tasks.

* **Efficient Reasoning, Robustness, and Reliable LLM Behaviour**, Alongside my work on agent memory, I study how language model behaviour can be made more efficient, controllable, and robust beyond
explicit token-level prompting. My work in this area explores latent spaces and continuous mechanisms, especially methods that compress reasoning [CODI, 2025 EMNLP Main](https://arxiv.org/abs/2502.21074), improve adversarial robustness through representation-level control [OSCR-Attack, 2026 ACL Findings](https://aclanthology.org/2026.findings-acl.1235/), and detect contextual hallucinations through frequency-aware analysis of model attention [Contextual Hallucination Detection, ICML 2026](https://openreview.net/forum?id=Mo6iakSLwn).

* **Multimodal Reasoning and Generation**, Another strand of my work focuses on multimodal reasoning and generation, particularly causal and temporal inference in vision–language tasks and human motion generation. This includes visual question
generation [Causal and Temporal Inference in Visual Question Generation, ACL ALVR 2024](https://aclanthology.org/2024.alvr-1.12/) and human motion generation [Human Motion Video Generation, TPAMI 2025](https://www.techrxiv.org/doi/full/10.36227/techrxiv.172793202.22697340).
