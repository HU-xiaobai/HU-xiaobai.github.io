...
explicit token-level prompting. My work in this area explores latent spaces and continuous mechanisms, especially methods that compress reasoning [CODI, 2025 EMNLP Main](https://arxiv.org/abs/2502.21074), guide internal representations, or improve robustness through representation-level control [OSCR-Attack, 2026 ACL findings].
...
generation [Causal and temporal inference in videos QA, ACL ALVR 2024](https://aclanthology.org/2024.alvr-1.12/), visual reasoning, visual localisation, decoding enhancement, and human motion generation [Human motion video generation, TPAMI 2025](https://www.techrxiv.org/doi/full/10.36227/techrxiv.172793202.22697340).
